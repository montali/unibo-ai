...
- **Discrete** random variables (finite or infinite): <!-- $\text{Weather}\in\{\text{sunny},\text{rain},\text{cloudy}\}$ --> <img style="transform: translateY(0.1em); background: white;" src="..\svg\u4GgzxrF6g.svg">, *Weather=rain*
