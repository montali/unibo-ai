...
\noindent Conjunctive Normal Form (CNF): $F = F_1 \land F_2 \land ... \land F_n $ where $F_i = F_{i1} \lor F_{i2} \lor ... \lor F_{ik} $.

\noindent Disjunctive Normal Form (DNF): $F = F_1 \lor F_2 \lor ... \lor F_n $ where $F_i = F_{i1} \land F_{i2} \land ... \land F_{ik} $.
...
\noindent Completeness theorem: $\Gamma \vdash \varphi \Rightarrow \Gamma \vDash \varphi$. Soundness theorem $\Gamma \vdash \varphi \Leftarrow \Gamma \vDash \varphi$.
